...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArtGroup.slug'
        db.add_column(u'main_artgroup', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=65, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArtGroup.slug'
        db.delete_column(u'main_artgroup', 'slug')
    ...
    models = {
        u'main.artgroup': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '65', 'null': 'True', 'blank': 'True'})
        },
        u'main.artwork': {
